...
- [x] **Toast notifications** · Toasts are overlapping, instead of making a vertical stack they overlap in the z-index. is this is a bug in the DaisyUI library? or is there a way to fix it? - Currently it's a single toast shared by all notifications, that explains the behaviour.
