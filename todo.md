...
- [x] **Book View** · When switching book views the scroll position is preserved, so users land in an arbitrary position in the newly selected book. Ideally scroll should be reset to the top of the book or preserved by book, not globally to the view.
