...
<footer
  class="footer footer-horizontal md:footer-vertical footer-center gap-12 bg-base-200 p-10 text-base-content"
>
  <aside class="flex items-center gap-4 text-center sm:text-left order-2 md:order-1">
    <Logo size={10} />
