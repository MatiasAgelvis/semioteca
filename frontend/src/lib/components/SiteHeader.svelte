    ...
    >
      ...
      <div class="flex items-center justify-end gap-2">
        ...
        <div class="flex shrink-0 items-center justify-end gap-2">
          {#if $selectedCount > 0}
            <a href="/cards/compose" class="btn btn-ghost" title="Ir al compositor">
              <div class="indicator">
                <svg viewBox="0 0 24 24" fill="none" class="size-5" stroke="currentColor" stroke-width="1.5">
                  ...
                  <path d="M8 16H13" stroke-linecap="round" />
                </svg>
                <span class="badge badge-success badge-xs indicator-item">{$selectedCount}</span>
              </div>
            </a>
          {/if}
          <ThemeSwitcher />
