  ...
  >
    <div class="flex flex-wrap items-center gap-x-3 gap-y-1 text-sm opacity-70">
      {#if fullResultsMode}
        ...
        >
        <button class="btn btn-ghost btn-xs shrink-0 gap-1" type="button" onclick={copyShareUrl} aria-label="Compartir enlace">
          <svg
          ...
          <span class="hidden md:inline">Compartir enlace</span>
        </button>
      {:else}
