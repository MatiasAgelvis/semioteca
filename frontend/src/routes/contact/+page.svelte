...
<div
  class="container mx-auto max-w-2xl m-8 rounded-2xl sm:border sm:border-base-300/70 bg-base-100/90 p-8 sm:shadow-xl sm:shadow-base-content/5 lg:p-12"
>
  ...
  {:else}
    ...
    <form onsubmit={handleSubmit} class="space-y-4">
      <div>
        <label for="name" class="block text-sm font-medium text-base-600 dark:text-base-400"
          >Nombre</label
        >
        <input
          type="text"
      ...
      <div>
        <label for="email" class="block text-sm font-medium text-base-600 dark:text-base-400"
      ...
      <div>
        <label for="message" class="block text-sm font-medium text-base-600 dark:text-base-400"
          >Mensaje</label
        >
        <textarea
          name="message"
